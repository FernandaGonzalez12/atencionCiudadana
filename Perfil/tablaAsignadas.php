<?php
      ...
      <thead>
          <tr><th>Identificador</th><th>Nombre Menu</th><th>Clic para eliminar</th><th></th></tr>
      </thead>
      <tbody>
";
...
<i class='material-icons eliminar' data-idopc='$idopcmenu' data-idmenu='$idmenu' data-nommenu='$nommenu'>close</i></td></tr>";
      }
      echo "</table>";
?>